...
ReactDOM.render(
  ...
  <div className="projetosBg" style={{ whiteSpace: 'pre-wrap' }}>
    ...
    <Projetos imgStyle={"imgProjetos"} img1={img4} titulo={"CrazyBall"} linkDownload={"https://itch.io/queue/c/1454709/meus-projetos?game_id=951717"} linkCode={""} descricao={"Introdução: Jogo de baseball em realidade virtual onde o jogador é o rebatedor, com alguns puzzles para obter pontuação.  \u000A Plataforma: PC  \u000A Engine: Unity  \u000A Linguagem de programação: C#  \u000A "}></Projetos>
